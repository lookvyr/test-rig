...
describe("release workflow client tracing boundary", () => {
  it.effect("does not propagate relay tracing credentials into product builds", () =>
    Effect.gen(function* () {
      ...
      expect(workflow).not.toContain("T3CODE_RELAY_CLIENT_OTLP_TRACES_TOKEN");
