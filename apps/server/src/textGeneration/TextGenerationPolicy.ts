...
export const TextGenerationPolicy = Schema.Struct({
  ...
  additionalCommitInstructions: Schema.optional(Schema.String),
  additionalChangeRequestTitleInstructions: Schema.optional(Schema.String),
  additionalChangeRequestDescriptionInstructions: Schema.optional(Schema.String),
