...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_WS_METHODS.searchThreadMessages]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.getThreadSearchContext]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.reviewSetFilesStaged]: AuthOrchestrationOperateScope,
