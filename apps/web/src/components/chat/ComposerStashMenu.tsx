...
/**
 * Popover listing stashed prompts, opened by the stash badge or ⌘S when the
 * empty composer cannot restore a single ready entry. Navigate with arrows,
 * restore with Enter, and dismiss with Escape. The listener runs capture-phase
