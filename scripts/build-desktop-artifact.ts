...
import {
  DEVELOPMENT_URL_SCHEME,
  PRODUCT_NAME,
  PRODUCT_PACKAGE_NAME,
  PRODUCT_SLUG,
  PRODUCTION_APP_ID,
  PRODUCTION_URL_SCHEME,
...
const DESKTOP_APP_ID = PRODUCTION_APP_ID;
...
export function resolveDesktopProductName(_version: string): string {
  return desktopPackageJson.productName ?? PRODUCT_NAME;
}
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
  ...
  if (platform === "mac") {
    buildConfig.mac = {
      ...
      protocols: [
        {
          name: PRODUCT_NAME,
          schemes: [PRODUCTION_URL_SCHEME, DEVELOPMENT_URL_SCHEME],
        },
      ],
      ...(macPasskeySigning
        ? {
  ...
  if (platform === "win") {
    ...
    if (target === "nsis") {
      buildConfig.nsis = { differentialPackage: false };
    }
  }
