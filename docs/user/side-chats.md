...
After starting a Codex conversation, enter `/side`, or open the right panel and choose **Side chat** from its **+** menu. Each conversation has one temporary side chat. Opening it again returns to the same side chat.
...
Side chats currently support Codex. Claude and OpenCode conversations do not offer them.
