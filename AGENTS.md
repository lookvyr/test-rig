...
T3 Code is a minimal GUI for coding agents. A Node WebSocket server wraps provider CLIs (Codex, Claude Code, OpenCode) and serves web, desktop, and mobile clients.
