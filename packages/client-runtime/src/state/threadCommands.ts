...
import {
  ...
  type OpenThreadSideInput,
  type KeepThreadSideInput,
  type DiscardThreadSideInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    openSide: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:open-side",
      execute: (input: OpenThreadSideInput) => openThreadSide(input),
      scheduler,
      concurrency,
    }),
    keepSide: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:keep-side",
      execute: (input: KeepThreadSideInput) => keepThreadSide(input),
      scheduler,
      concurrency,
    }),
    discardSide: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:discard-side",
      execute: (input: DiscardThreadSideInput) => discardThreadSide(input),
      scheduler,
      concurrency,
    }),
